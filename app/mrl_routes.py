...
mrl_bp = Blueprint("mrl", __name__, url_prefix="/mrl")

_ROOT = Path(__file__).resolve().parent.parent / "docs" / "mrl"
...
@mrl_bp.route("/css/<path:filename>")
...
@mrl_bp.route("/chapters/<path:filename>")
...
@mrl_bp.route("")
def index_no_slash():
    return redirect(url_for("mrl.index"))
