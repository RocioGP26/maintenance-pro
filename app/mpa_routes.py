...
mpa_bp = Blueprint("mpa", __name__, url_prefix="/mpa")

_ROOT = Path(__file__).resolve().parent.parent / "docs" / "mpa"
...
@mpa_bp.route("/css/<path:filename>")
...
@mpa_bp.route("/chapters/<path:filename>")
...
@mpa_bp.route("")
def index_no_slash():
    return redirect(url_for("mpa.index"))
