...
- feat: conversión comercial del trial (#16).
...
- Runbook de recuperación de backups (RTO/RPO, procedimiento, integridad) y plantilla de simulacro.
...
- Observabilidad, Redis y worker operativo (Sprint 23.4).

## [1.0.18] - 2026-07-28

### Changed

- Mensaje de OT actualizada incluye el número de orden.
...
- Docs publicos solo en /docs/, recuperar contrasena por correo y manual de usuario /manual.
...
- docs hibrido publico/privado, brochure MKT y hub Documentacion interna en SuperAdmin.

## [1.0.10] - 2026-07-23

### Changed

- fix: restringir credenciales API al área TI/TIC (#11).
