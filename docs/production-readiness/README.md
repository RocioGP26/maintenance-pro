...
| 23.5 | Dominio, correo y preparación comercial | En curso · identidad de correo aprobada |
...
- `SPRINT23.5-CHARTER.md`: alcance y criterios de preparación para comercialización.
- `SPRINT23.5-REPORT.md`: evidencia de dominio, correo y aceptación técnica.
- `SPRINT23.5-UAT.md`: evidencia histórica de aceptación sobre el tenant de prueba.
...
- `storage-certification.md`: evidencia y gate de certificación R2 de producción.
