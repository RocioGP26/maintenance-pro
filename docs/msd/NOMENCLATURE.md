...
|--------|---------|--------|
| **MSD-01-PHIL** | `01-filosofia-ecosistema.md` | Filosofía del ecosistema |
...
| **MSD-09-PUB** | `09-publicacion.md` | Publicación de paquetes |
...
| MAG | MSD |
|-----|-----|
| Contrato REST | Clientes y herramientas |
| Ejemplos curl/Python | SDK + Quick Start |
| OpenAPI (referencia) | OpenAPI (fuente de generación) |
| Buenas prácticas | CLI · colecciones · portal |

## Estado Sprint 9

| Capítulo | Estado |
|----------|--------|
| MSD-01 – MSD-09 | ✅ Entregado |
| **MSD v1.0** | ✅ Sprint 9 completo |
