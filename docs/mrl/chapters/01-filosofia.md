...
## 1 · El problema sin MRL

Sin estándar, cada módulo inventa:

- Encabezados distintos
- Tablas con otro azul
...
| # | Principio |
|---|-----------|
| 1 | **Un solo lenguaje visual** para todo documento generado |
| 2 | **Reconocible sin logo** — tipografía, estructura, color |
| 3 | **Profesional en impresión** — A4, márgenes, contraste |
| 4 | **Hereda MDL** — mismos tokens, no paleta paralela |
| 5 | **Módulo agnóstico** — OT, factura o inventario usan la misma anatomía |
| 6 | **ReportLab como motor** — estándar documentado, implementación uniforme |
...
## 4 · Audiencias del documento impreso

| Quién recibe | Qué debe sentir |
|--------------|-----------------|
...
— también en el documento que sale de ella.

---

→ [MRL-02-DOC · Tipos de documentos](02-tipos-documentos.md)
