# MCM-08-OBJ · Objeciones

**Código:** MCM-08-OBJ · Sprint 5.8  
...
**Prerequisitos:** [MCM-04-DMU](04-buyer-personas-dmu.md) · [MCM-06-PLAN](06-planes-comerciales.md) · [MCM-07-DEMO](07-demo-comercial.md)
...
## Plantilla · Ficha de objeción

Cada objeción del manual sigue esta estructura:

| Campo | Contenido |
|-------|-----------|
| **Objeción** | La frase exacta (o variante) del cliente |
| **Nivel de riesgo** | 🟢 Bajo · 🟡 Medio · 🔴 Alto — prioridad de preparación |
| **Quién debe responder** | Comercial · Comercial + Producto · Preventa/TI · Fundador o Comercial Senior |
...
Códigos internos: **OBJ-001** a **OBJ-010** — ver [NOMENCLATURE.md](../NOMENCLATURE.md#objeciones--códigos-obj).

---

## Categorías de fondo

Antes de responder, identifica **de qué habla realmente** el cliente:

| Categoría | Señales | Enfoque de respuesta |
|-----------|---------|----------------------|
| **Precio** | «Caro» · «No hay presupuesto» | Costo de **no** cambiar · plan por etapa |
| **Tiempo** | «No tenemos tiempo» · «Ahora no» | Valor en días · trial 15 · PLAY-001 |
| **Riesgo** | «¿Y si falla?» · «A medida» | Trial · misma plataforma · Start |
| **Confianza** | «No lo usarán» · «¿Y ustedes?» | MUX · onboarding · casos sector |
| **Proceso** | «Más cotizaciones» · «Comité» | Evidencia antes de RFP · champion |
| **Técnico** | «Integración» · «La nube» | Arquitectura SaaS · roadmap honesto |

---

## Índice de fichas

| Código | Objeción | Categoría | Riesgo | Mejor responde | Momento típico |
|--------|----------|-----------|--------|----------------|----------------|
| **OBJ-001** | «Es muy caro» | Precio | 🟡 Medio | Comercial | Durante el **cierre** |
| **OBJ-002** | «No tenemos tiempo» | Tiempo | 🟡 Medio | Comercial | **Calificación** / pre-demo |
| **OBJ-003** | «Queremos a medida» | Riesgo | 🔴 Alto | Comercial + **Producto** | **Discovery** o demo (TI en sala) |
| **OBJ-004** | «No lo van a usar» | Confianza | 🟢 Bajo | Comercial | Durante la **demo** |
| **OBJ-005** | «Excel nos funciona» | Status quo | 🟡 Medio | Comercial | **Apertura** (PLAY-002) |
| **OBJ-006** | «Más cotizaciones» | Proceso | 🟢 Bajo | Comercial | Durante el **cierre** |
| **OBJ-007** | «¿Y si desaparecen?» | Confianza | 🔴 Alto | **Fundador** o Comercial Senior | **Cierre** o follow-up Dueño/TI |
| **OBJ-008** | «Sector muy específico» | Fit | 🟡 Medio | Comercial | **Apertura** (PLAY-002) |
| **OBJ-009** | «No es prioridad» | Tiempo | 🟡 Medio | Comercial | **Calificación** / cierre |
| **OBJ-010** | «¿Integran con ERP?» | Técnico | 🟢 Bajo | **Preventa / TI** | **Después** de la demo |

**Regla de riesgo:** 🔴 Alto → preparar evidencia y escalar rol antes de la reunión. 🟢 Bajo → el comercial puede resolver en el momento.
...
| **Evidencia** | MCM-02 · **MTX-CASE** Antes/Después · **PLAY-004** · plan **Start** (MCM-06) · trial 15 días |
...
## OBJ-002 · «No tenemos tiempo para implementar»
...
## OBJ-003 · «Queremos algo a medida»

| Campo | Contenido |
|-------|-----------|
| **Nivel de riesgo** | 🔴 **Alto** |
| **Quién debe responder** | **Comercial + Producto** |
...
## OBJ-004 · «Los operarios no lo van a usar»

| Campo | Contenido |
|-------|-----------|
| **Nivel de riesgo** | 🟢 **Bajo** |
| **Quién debe responder** | **Comercial** *(champion operativo en sala refuerza)* |
...
## OBJ-005 · «Excel nos funciona bien»
...
## OBJ-006 · «Necesitamos más cotizaciones»
...
| **Quién debe responder** | **Comercial** |
| **Momento típico** | Durante el **cierre** (PLAY-005) |
| **Objeción** | «Tenemos que pedir tres cotizaciones.» · «Compras exige RFP.» · «Mándenos la propuesta y la evaluamos.» |
| **Qué significa realmente** | **Proceso** — no es rechazo; es cumplimiento interno. Riesgo de quedar en «cajón de comparativas» sin champion. |
| **Cómo responder** | *«Perfecto — respetamos su proceso. Lo que proponemos es invertir el orden: **trial de 15 días** con criterios claros, para que la comparación no sea solo precio en papel sino valor en su operación. Así Compras evalúa con evidencia y ustedes llegan al RFP con un champion que ya probó el sistema.»* |
| **Evidencia** | Trial 15 días · Exit Criteria MCM-07 · plan recomendado MCM-06 · folleto + MCM |
| **Error común** | Negarse al proceso · enviar propuesta sin reunión de cierre · no identificar champion en Compras |
| **Siguiente pregunta** | *«¿Qué criterios usará Compras además del precio — tiempo de implementación, soporte, escalabilidad? Podemos alinear el trial a esos criterios.»* |

---

## OBJ-007 · «¿Qué pasa si ustedes desaparecen?»

| Campo | Contenido |
|-------|-----------|
| **Nivel de riesgo** | 🔴 **Alto** |
| **Quién debe responder** | **Fundador** o Comercial Senior |
...
## OBJ-008 · «Somos muy específicos / sector diferente»
...
| **Siguiente pregunta** | *«¿Qué parte de su operación siente que **ningún** sistema entendería — y eso es lo que más le preocupa?»* |

---

## OBJ-009 · «Ahora no es prioridad»

| Campo | Contenido |
|-------|-----------|
| **Nivel de riesgo** | 🟡 **Medio** |
| **Quién debe responder** | **Comercial** |
| **Momento típico** | **Calificación** / cierre — urgencia baja (MCM-03) |
| **Objeción** | «Lo vemos el próximo trimestre.» · «Hay proyectos más urgentes.» · «Llámenos en seis meses.» |
| **Qué significa realmente** | **Tiempo** + **urgencia baja** (MCM-03) — puede ser real o cortesía. Sin urgencia, el pipeline se enfría. |
| **Cómo responder** | *«Lo respeto. Para no perder su tiempo ni el nuestro: ¿qué tendría que pasar en la operación para que esto **sí** sea prioridad? Mientras tanto, el trial de 15 días puede correr en paralelo sin proyecto formal — muchos clientes lo activan cuando el dolor aparece, no cuando hay presupuesto cerrado.»* |
| **Evidencia** | Urgencia ICP · trial sin compromiso · nurture (folleto, caso sector) · fecha concreta en CRM |
| **Error común** | Aceptar «llámenos» sin fecha · presionar sin urgencia real · no registrar en CRM |
| **Siguiente pregunta** | *«¿Hay algún evento — temporada, auditoría, nueva sede — que haga esto urgente antes de [fecha que ellos dijeron]?»* |

---

## OBJ-010 · «¿Integran con nuestro ERP / contabilidad?»
...
## Matriz · Objeción por rol (DMU)

Extiende el adelanto de [MCM-04-DMU](04-buyer-personas-dmu.md):

| Rol | Objeción frecuente | Ficha | Énfasis |
|-----|-------------------|-------|---------|
| Gerente General | Tiempo · prioridad | OBJ-002 · OBJ-009 | Transformación · PLAY-004 |
| Finanzas | Precio · ROI | OBJ-001 · OBJ-006 | Costo de no cambiar · Start |
| TI | A medida · datos · integración | OBJ-003 · OBJ-007 · OBJ-010 | SaaS · trial · roadmap |
| Técnico / Bodega | Adopción | OBJ-004 | MUX · PLAY-003 |
| Compras | Cotizaciones | OBJ-006 | Trial antes de RFP |
| Operaciones | Excel basta | OBJ-005 | ICP · historia sector |

---

## Flujo · Objeción en la reunión

```
Cliente objeta
      │
      ▼
¿Qué categoría de fondo? (precio · tiempo · riesgo · confianza · proceso · técnico)
      │
      ▼
Buscar ficha OBJ-00X · NO memorizar — adaptar guion
      │
      ▼
Mostrar evidencia (demo · KPI · trial · plan)
      │
      ▼
Siguiente pregunta — descubrimiento
      │
      ▼
Registrar en Debrief (MCM-07) → alimenta este capítulo
```
...
| Código | Uso con objeciones |
|--------|-------------------|
| **MCM-03-ICP** | Band C/D — OBJ-005 y OBJ-009 más frecuentes |
| **MCM-04-DMU** | Misma objeción, distinto rol — cambia evidencia |
| **MCM-05-SECT** | OBJ-008 — idioma del sector |
| **MCM-06-PLAN** | OBJ-001 — Start vs Enterprise |
| **MCM-07-DEMO** | Debrief → nuevas objeciones · PLAY para evidencia |
| **MCM-09-CASE** *(activo)* | Evidencia social · MTX-CASE por sector |
...
**Próximo capítulo:** MCM-10-GTM · Go To Market (Sprint 5.10)

---

*MCM-08-OBJ · Maintix Commercial Manual · 2026*
