...
> ⚠️ **Apéndice Sprint 5** — Referencia de calificación. Capítulos principales: [MCM-01-INTRO](../01-intro-filosofia-comercial.md) · [MCM-03-MARKETS](../03-sectores-mercados.md).
