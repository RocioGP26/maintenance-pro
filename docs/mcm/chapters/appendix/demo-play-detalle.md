# MCM-07-DEMO · La demo comercial (detalle extendido)

> ⚠️ **Apéndice Sprint 5** — Fichas · debrief · matrices por rol. Capítulo principal: [MCM-07-DEMO](../07-demo-comercial.md).
...
**Prerequisitos:** [ICP (apéndice)](appendix/icp-score.md) · [DMU (apéndice)](appendix/buyer-personas-dmu.md) · [MCM-03-MARKETS](03-sectores-mercados.md) · [MCM-04-PLANS](04-planes-saas.md) · [MCM-06-ONBOARD](06-onboarding-implementacion.md)
...
| **PLAY-002** | Apertura | 3 min | Conectar con el dolor real | Repetir la **historia del sector** (MCM-03-MARKETS) |
...
|-------|------------|------------|
| **ICP Score** | ICP (apéndice) | Banda A/B/C/D · puntos clave |
| **Urgencia** | ICP (apéndice) | Alta / Media / Baja |
| **Champion** | ICP (apéndice) | Nombre · Strength 🟢🟡🔴 |
| **Sector** | MCM-03-MARKETS | Manufactura · Comercio · Agro… |
| **Módulo de entrada** | MCM-03-MARKETS · ICP | Maintenance · Inventory · Mixto |
| **Historia de demo** | MCM-03-MARKETS | Copiar la historia del sector — es tu apertura |
| **Perfiles MUX** | MUX · MCM-03-MARKETS | Quién opera · quién decide |
| **DMU en sala** | DMU (apéndice) | Roles presentes · decisor · bloqueador |
| **Plan sugerido** | MCM-04-PLANS | Start / Grow / Scale / Enterprise |
| **Resultado esperado** | MCM-04-PLANS | Qué consigue el cliente con ese plan |
...
| En la sala | Énfasis en operación | Ver DMU (apéndice) |
|------------|----------------------|------------|
...
Usa la **historia de demo** de [MCM-03-MARKETS](03-sectores-mercados.md) como hilo conductor — no inventes un caso nuevo en la reunión.
...
2. Señalar **1–2 KPIs** del sector (prioridad 1️⃣ y 2️⃣ de MCM-03-MARKETS).
...
|--------|------|-----------|
| 0:00 | **Plan recomendado** | Perfil ideal + resultado esperado (MCM-04-PLANS) |
...
3. Revisar si el ICP o el DMU estaban mal calificados (ICP (apéndice) · DMU (apéndice)).
...
| **ICP (apéndice)** | Prioridad · banda · puerta de entrada |
| **DMU (apéndice)** | Quién está en la sala · adaptar énfasis |
| **MCM-03-MARKETS** | Historia de demo · KPIs · MUX por sector |
| **MCM-04-PLANS-PLAN** | Plan recomendado · resultado esperado · cierre |
...
**Próximo capítulo:** [MCM-08-FAQ · Preguntas frecuentes](08-faq.md)
