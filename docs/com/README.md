...
| **COM-03** | [Piloto / Fundadores](COM-03-programa-piloto-fundadores.md) | 1.3.2 |

## Matriz vigente (año 1)

| | Start | Business | Enterprise |
|--|------:|---------:|------------|
| Precio / mes | **$1.000.000** | **$1.500.000** | No publicar |
...
| **Storage** | **1 GB** | **5 GB** | **20 GB ampliables** |
| Soporte | Email | Chat | Dedicado |

**v2 (futuro):** 2 / 10 / 50 GB como mejora anunciada.
