...
## Qué incluye cada manual

### 01 · Brand Book v2.0
Identidad, historia dual (mantenimiento + comercio), voz, pilares de mensaje, isotipo y aplicaciones de marca.

### 02 · MDL v1.0
Tokens, componentes `mtx-*`, fichas `MTX-*`, motion, dark mode, patrones, email.

### 03 · MUX v1.2
Personas, 5 UX Laws (cultura pre-merge), DEC, COPY, MEASURE, RESEARCH, journeys, accesibilidad.

### 04 · MCM v1.0
10 capítulos · PLAY-001–005 · OBJ-001–010 · MTX-CASE-001–006 · GTM · Sprint 5 completo.

---

## Política a partir de aquí

Cualquier cambio importante genera **nueva versión**, no edición silenciosa del congelado.
